...
namespace BackEnd_PGI.Migrations
{
    ...
    [Migration("20240525110922_UsersMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd_PGI.Model.TipoIOC", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BackEnd_PGI.Model.Asset", b =>
                {
                    ...
                    b.HasOne("BackEnd_PGI.Model.TipoAsset", "TipoAsset")
                        .WithMany()
                        .HasForeignKey("TipoAssetID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TipoAsset");
                });

            modelBuilder.Entity("BackEnd_PGI.Model.IOC", b =>
                {
                    b.HasOne("BackEnd_PGI.Model.Asset", null)
                        .WithMany("IOCs")
                        .HasForeignKey("AssetID");

                    b.HasOne("BackEnd_PGI.Model.TipoIOC", "TipoIOC")
                        .WithMany()
                        .HasForeignKey("TipoIocId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TipoIOC");
                });
            ...
            modelBuilder.Entity("BackEnd_PGI.Model.Usuario", b =>
                {
                    b.HasOne("BackEnd_PGI.Model.Rol", null)
                        .WithMany("Usuarios")
                        .HasForeignKey("RolID");
                });
